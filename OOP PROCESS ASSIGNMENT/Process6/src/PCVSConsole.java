                ...
                case 3 -> {
                    ...
                    if(idx == -1) {
                        ...
                        if(view == 1) {
                            ...
                            input.nextLine();
                            if (record == 1) {
                                Vaccine VC = pcvs.getPCVSVaccines().get(0);
                                System.out.println("\nDEBUG " + VC);
                                boolean once1 = true, once2 = true, once3 = true;
                                for (int j = 0; j < VC.getBatches().size(); j++) {
                                    HealthcareCentre centreName1 = pcvs.getPCVSHealthcareCentres().get(0);
                                    HealthcareCentre centreName2 = pcvs.getPCVSHealthcareCentres().get(1);
                                    HealthcareCentre centreName3 = pcvs.getPCVSHealthcareCentres().get(2);
                                    if(centreName1 == pcvs.findHealthcareCentre(VC.getBatches().get(j)) && once1) {
                                        System.out.println(pcvs.findHealthcareCentre(VC.getBatches().get(j)));
                                        once1 = false;
                                    }
                                    else if(centreName2 == pcvs.findHealthcareCentre(VC.getBatches().get(j)) && once2) {
                                        System.out.println(pcvs.findHealthcareCentre(VC.getBatches().get(j)));
                                        once2 = false;
                                    }
                                    else if(centreName3 == pcvs.findHealthcareCentre(VC.getBatches().get(j)) && once3) {
                                        System.out.println(pcvs.findHealthcareCentre(VC.getBatches().get(j)));
                                        once3 = false;
                                    }
                                }
                                ...
                                Vaccine VC = pcvs.getPCVSVaccines().get(1);
                                System.out.println("\nDEBUG " + VC);
                                for (int j = 0; j < VC.getBatches().size(); j++) {
                                    System.out.println(pcvs.findHealthcareCentre(VC.getBatches().get(j)));
                                }
                                ...
                                Vaccine VC = pcvs.getPCVSVaccines().get(2);
                                System.out.println("\nDEBUG " + VC);
                                for (int j = 0; j < VC.getBatches().size(); j++) {
                                    System.out.println(pcvs.findHealthcareCentre(VC.getBatches().get(j)));
                                }
...
//                    Debug patient
                ...
                case 14-> {
                    System.out.println(pcvs.findVaccineBatch(0));
                }
