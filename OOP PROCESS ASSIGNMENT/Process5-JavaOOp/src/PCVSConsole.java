            ...
            switch (menu) {
                ...
                case 3 -> {
                    ...
                    if(idx == -1) {
                        ...
                        System.out.println("\n" + pcvs.getPCVSUsers().get(idx).getFullName());
                        System.out.println("Select to view available vaccines");
                        ...
                        /*
                        * if select 0 jnj, tampilkan rumah sakit2
                        * */
...
//                    Debug patient
                ...
                case 14-> {
                    //System.out.println(pcvs.findHealthcareBatchVaccine());
                }
