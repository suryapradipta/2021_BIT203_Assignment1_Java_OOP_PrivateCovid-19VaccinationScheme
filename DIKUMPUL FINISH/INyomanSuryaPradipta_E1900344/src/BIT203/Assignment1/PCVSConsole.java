...
public class PCVSConsole {
            ...
            switch (menu) {
                ...
                case 2 -> {
                    ...
                    if (iAdmin == -1) {
                        ...
                        out.println(pcvs.userLogin(username,password));
                    ...
                    if(iPatient == -1) {
                        ...
                        while(repeat) { // Loop until Patient select HealthcareCentre to view
                            ...
                            if(view == 1) {
                                ...
                                PCVS pcvs1 = pcvs;
                                for (Batch batch : tempVaccine.getBatches()) {
                                    int iBatch = pcvs1.equalsBatch(batch);
                                    if (!tempHC.contains(iBatch)) {
                ...
                case 6 -> {
                    ...
                    input.nextLine();
                    if(view == 1) {
                        for (User user : pcvs.getPCVSUsers()) {
                            String s = "\n" + user;
                            out.println(s);
                        }
                    }
    ...
    public static boolean writeEmployeeObjects(ArrayList<User> userArrayList, String fileName) {
    ...
    // save() method in TPCConsole.java
// assume tpc has been created and contains
// collections of employees and projects
    ...
    public static void load() {
        ...
        String filename = input.nextLine();
        FileInputStream fis;
        ArrayList<User> userArrayList = pcvs.getPCVSUsers();
        User user = null;
        try {
