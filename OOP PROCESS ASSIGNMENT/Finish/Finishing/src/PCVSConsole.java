        ...
        while (menu != 20) {
            ...
            while(!menuExc)
                try {
                    ...
                    System.out.println("6. Display detail of all users");
                    System.out.println("7. Display detail of all vaccination appointments");
                    System.out.println("20. Quit the program.");
                    System.out.print("Menu of choices: ");
                    menu = Integer.parseInt(input.nextLine()); // skip the new line character
            ...
            switch (menu) {
                case 1 -> {
                    ...
                    while(!signUpExc)
                        try {
                            ...
                            System.out.print("Menu of choices: ");
                            signUp = Integer.parseInt(input.nextLine()); // skip the new line character
                            signUpExc = true;
                        }
                    ...
                    if(iPatient == -1) {
                        ...
                        while(repeat) {
                            ...
                            if(view == 1) {
                                ...
                                VC.getBatches().stream().mapToInt(pcvs::findVaccineToHealthcareCentre)
                                    .filter(index -> !tempHC.contains(index))
                                    .forEach(index -> {
                                        System.out.println(index + 1 + ". " + pcvs.getPCVSHealthcareCentres().get(index));
                                        tempHC.add(index);
                                    });
                                System.out.println("3. Back to vaccination appointment menu");
                        ...
                        input.nextLine();
                        //uc 3
                        int iBatch = pcvs.findBatch(viewHC, record, selectBatchNum);
                ...
                case 6 -> {
                    System.out.println("\n1. Original sequence ");
                    System.out.println("2. Sorted according to full name");
                    System.out.print("Menu of choices: ");
                    int view = input.nextInt();
                    input.nextLine();
                    if(view == 1) {
                        ...
                        patients.sort(Comparator.comparing(Patient::getFullName));
                    ...
                    for (int i = 0; i < pcvs.getPCVSVaccines().size(); i++) {
                        ...
                        for (int j = 0; j < tempVC.getBatches().size(); j++) {
                            ...
                            for (int k = 0; k < tempBatch.getVaccinations().size(); k++) {
                                ...
                                System.out.println(tempVaccination);
                                System.out.println("Remarks: " + tempVaccination.getRemarks());
                            }
                        }
                    }
                }
                ...
                case 12 -> {
                    for (int x = 0; x < pcvs.getPCVSUsers().size(); x++) {
                        if (pcvs.getPCVSUsers().get(x) instanceof Patient tempPatient) {
                            for (int y = 0; y < tempPatient.getVaccinations().size(); y++) {
                                System.out.println("Hasil: " + tempPatient.getVaccinations());
                            }
                        }
                    }
                }
